...
# 修改为res2net的block结构;kernel_size默认为3
def conv_block(input_tensor, kernel_size, filters, stage, block,
    ...
    print(x)
    print(shortcut)
    out = KL.Add(name='res'+str(stage)+block+'_add')([x, shortcut])
    print(out)
    out = KL.Activation('relu', name='res' + str(stage) + block + '_out')(out)
    return out
